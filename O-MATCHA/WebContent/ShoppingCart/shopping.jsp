		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<div  class="fangda">
					<input class="shouji" /><span >收货人手机</span> 
					</div>
					...
					<div class="fangda" >
					<input class="shouji" /><span>预约人手机</span> 
					</div>
				...
				<div class="fangda1" style="margin-top:50px;"> 
					<span>添加订单备注</span> <input placeholder="限定60字！（请将购买需求在备注中详细说明）" maxlength="60" style="margin-left:30px;" ></input>
				...
				<div id="zhifu">
					...
					<span><button onclick="zhifufangs(this)">微信支付</button><button onclick="zhifufangs(this)">支付宝支付</button><button onclick="zhifufangs(this)">现金支付</button></span>
				</div>
				...
				<div style="border: 1px solid gray; margin-top:80px;">
					<ul id="tongji">
						...
						<li>
							<a href="<%=path%>/ShoppingCart/shopping cart.jsp">返回购物车</a>
						</li>
					</ul>
					<div>
					<div id="zongji1">
						<p> 总计￥<span>129.00</span></p>
					</div>
					 <a id="modal-85897" href="#modal-container-85897" role="button" class="btn" data-toggle="modal" onclick="panduan(this)">提交订单</a>
					</div>
				</div>
