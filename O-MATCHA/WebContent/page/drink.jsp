...
<body>
	...
	<div class="related-products" style="margin-top:100px">
		<div class="container">
			...
			<c:forEach items="${drinklist}" var="drink">
				<div class="product-grid single-product">
					<a href="<%=path %>/single.do?gid=${drink.gid}">
					<div class="more-product"><span> </span></div>						
					<div class="product-img b-link-stripe b-animate-go  thickbox">
						<img src="<%=path%>/qingxiping/images/goods/${drink.image3 }" class="img-responsive" alt="">
						<div class="b-wrapper">
					...
					<div class="product-info simpleCart_shelfItem">
						<div class="product-info-cust prt_name">
							<h4>${drink.name }</h4>								
							<span class="item_price">$<span>${drink.price }</span></span>
 	...
 	<!--分页导航-->
<ul class="pager">
    <li><a href="?dstart=${dpre}">&laquo;上一页</a></li>
    <li><a href="?dstart=${dnext}">下一页&raquo;</a></li>
</ul>
 	<!--底部信息栏-->
