...
<!-- /container --> 
	...
	<div id="cake">
		...
		<div class="col-md-3 column" style="text-align:center">
			...
			<p>
				 <a class="btn" href="<%=path%>/page/cake.jsp" style="color:#FF8000">更多详情 »</a>
			</p>
		</div>
		<div class="col-md-3 column" style="text-align:center">
	...
	<div id="coffee">
		...
		<div class="col-md-3 column" style="text-align:center">
			...
			<p>
				 <a class="btn" href="<%=path%>/page/coffee.jsp" style="color:#FF8000">更多详情 »</a>
			</p>
		</div>
		<div class="col-md-3 column" style="text-align:center">
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-3 column" style="text-align:center">
			...
			<p>
				 <a class="btn" href="<%=path%>/page/drink.jsp" style="color:#FF8000">更多详情 »</a>
			</p>
		</div>
		<div class="col-md-3 column" style="text-align:center">
